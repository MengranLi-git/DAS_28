...
Factors of satisfaction with public transport
...
## Variables
 ...
 [1] FeatureCode: region code
 
 [2] DateCode: year, control variable 
 
 [3] Expenditure,  
 
 [4] Killed_Injured: People killed Or seriously injured by traffic casualties                                                              
 [5] Cards: Number of concessionary cards issued to all adults.
...
Totally 460 observations.

## Methods:

-  EDA (summarize, density plot, scatter plot, correlation)
