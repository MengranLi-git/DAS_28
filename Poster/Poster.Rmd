...
-   **Model diagnosis** are carried out to check model assumptions. **Stepwise regression** is applied to select variables with **AIC** as the criterion. Compare the selected model with the full model in $adj$ $R^2$, AIC and BIC.
